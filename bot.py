...
# Админ видит всё как студент + отдельная админка
# ============================================================
...
def main_menu(user_id: int = 0):
    """Меню студента. У админа — с кнопкой Админ-панели в конце."""
    keyboard = [
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    if is_admin(message.from_user.id):
        text = (
            ...
            "Ты вошёл как *админ* 👨‍💼\n\n"
            "📌 *Тебе доступно:*\n"
            "• всё меню студента (смотреть расписание и т.д.)\n"
            "• кнопка «👨‍💼 Админ-панель» внизу\n"
            "• команда `/admin`\n\n"
            "🧭 Путеводитель\n⏰ Звонки\n📅 Расписание\n"
            "👥 Моя группа\n📢 Объявления\n📋 Чек-лист\n"
            "📖 Словарь\n🆘 SOS\n🏛 О РУК\n📞 Контакты\n🔗 Ссылки"
...
# ============================================================
# 👨‍💼 АДМИН-ПАНЕЛЬ (только по команде /admin или кнопке)
# ============================================================
...
# ============================================================
# 💾 СОСТОЯНИЯ (только для админа — двойная защита)
# ============================================================
...
# ============================================================
# 🧭 СТУДЕНЧЕСКИЕ РАЗДЕЛЫ (админ видит их ТАК ЖЕ, как студент)
# ============================================================
...
async def bells_cmd(message: Message):
    """Звонки — видят все, включая админа."""
    if not BELLS:
...
async def schedule_cmd(message: Message):
    """Расписание — видят все, включая админа. Админ редактирует через 🔧."""
    if not SCHEDULE:
...
async def announces_cmd(message: Message):
    """Объявления — видят все, включая админа."""
    if not ANNOUNCES:
